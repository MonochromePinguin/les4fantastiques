 ...
 ?>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12">
				<h2 class="text-center"><img class="pacman" src="pacman.png"> Select a character <img class= "joystick" src="joystick.png"></h2>
			</div>
		</div>
		<div class="row">
			<div class="col-12 text-center">
				<button type="button" class="btn btn-danger btn-lg "> Choose ! </button>
			</div>
